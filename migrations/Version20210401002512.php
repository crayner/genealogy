 ...
 */
final class Version20210401002512 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX identifier ON family (identifier)');
        ...
        $this->addSql('CREATE UNIQUE INDEX identifier ON individual (identifier)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX identifier ON family');
        ...
        $this->addSql('DROP INDEX identifier ON individual');
