 ...
 */
final class Version20210331220507 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD place CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:guid)\', CHANGE event_source event_source VARCHAR(255) NOT NULL, CHANGE type type VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7741D53CD FOREIGN KEY (place) REFERENCES place (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3BAE0AA7741D53CD ON event (place)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3BAE0AA7741D53CD ON event');
        $this->addSql('ALTER TABLE event DROP place, CHANGE event_source event_source VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE type type VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
