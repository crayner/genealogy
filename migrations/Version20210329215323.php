 ...
 */
final class Version20210329215323 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE header ADD destination VARCHAR(191) NOT NULL, ADD date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', ADD file VARCHAR(191) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE header DROP destination, DROP date, DROP file');
    }
}
